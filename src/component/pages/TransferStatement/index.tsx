...
import { useAccountStatementData } from "../../../Framework/placeBet";
...
const TransferStatement: React.FC = () => {
  ...
  const { data, isError, isLoading } = useAccountStatementData(payload);
 ...
 className="w-full" />
            ...
            <div className="w-full min-h-[calc(100dvh-150px)] flex items-center justify-center flex-col">
              <img src="icons/nofound.svg" alt="No Data" width={400} height={400} />
              {
                (data||[])?.length ? "":  <span className="text-text_Ternary font-normal text-center">No data found for selected date range...</span>
              }
