  ...
  return (
    ...
    <div className="intro">
      ...
      <div className="mt-1 mb-1 text-justify leading-tight">
        ...
        <strong> Playfunexch </strong>terms and conditions.
      </div>
      <div className="mt-1 mb-1 text-justify leading-tight">
        The Rules apply to all bets placed on this online betting
        platform (<b>Playfunexch</b>). The Rules consist of the
        following:
      </div>
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        ...
        <li>
          In particular, customers who use the "one-click" option to
          place bets are solely responsible for their actions and the
          Site shall have no liability to such customers for any errors
          made by customers when using this option.
        </li>
      </ul>
    </div>
    <div title="General Rules" className="general mt-3">
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        <li>
          ...
          <ol className="list-decimal pl-6 leading-tight">
            ...
            <li>
              if the event does not have a scheduled 'off' time, the
              Site will use its reasonable endeavours to ascertain the
              time of the actual 'off' and all bets after the time of
              the 'off' determined by the Site will be void.
            </li>
          </ol>
        </li>
        <li>
        ...
        <li>
          ...
          that transmissions described as "live" by some broadcasters
          may actually be delayed or pre-recorded. The extent of any
          delay may vary depending on the set-up through which they are
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        <li>
          ...
          turn such markets in-play at the time of the 'off'. However,
          the Site does not guarantee that such markets will be
          suspended and turned in-play at the time of the 'off'.
        </li>
        <li>
          ...
          event, all bets matched after the scheduled time of the 'off'
          will be void (in the case of horseracing and greyhound racing,
          bets will be void from the official rather than the scheduled
          'off' time). If the event does not have a scheduled 'off'
          time, the Site will use its reasonable endeavours to ascertain
          the time of the actual 'off' and all bets after the time of
          the 'off' determined by the Site will be void.
        </li>
        <li>
          If a market is scheduled to be turned in-play but the Site
        ...
        <li>
          ...
          <ol className="list-decimal pl-6 leading-tight">
            ...
            <li>
              ...
              been one or more "Material Events", any bets matched
              between the first "Material Event" and the market being
              turned in-play will be void.
            </li>
          </ol>
        </li>
        <li>
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        <li>
          ...
          minimum potential winnings of that customer on a given market)
          ...
          the Site initially settled the market; or (ii) if the whole
          market is eventually voided (e.g. for an abandoned event).
        </li>
        <li>
        ...
        <li>
          ...
          being made to a customer's balance to reflect changes in
          market settlement.
        </li>
      </ul>
      <h3 className="text-text_Ternary  font-[600] font-lato mt-2 mb-1.5 text-[18px]">
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        <li>
          ...
          terms and conditions or for any exception under the Rules, if
          a market contains a statement that says "All bets stand, run
          or not" (or something similar), then all bets on a team or
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        <li>
          ...
          the competitor named in a 'Winner with …' market title does
          not participate in the tournament or event then all bets on
      ...
      <div className="mt-1 mb-1 text-justify leading-tight">
        ...
        be determined by the competitor or team that qualifies, whether
        or not they take part in the next round or event for which they
    ...
    <div className="specific">
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        <li>
          ...
          number of overs for that game have been completed as
          determined by the match officials. If the required number of
          overs for that match has not been completed, the match will be
          treated as "Match Abandoned" or "No Result" and bets will be
          settled accordingly.
        </li>
        <li>
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        ...
        <li>
          For Advance Session markets denoted by 'ADV' in market name
          only the 1st team to bat Innings markets are valid. For Test
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        ...
        <li>
          ...
          specifying the term 'XI' in the name). If an official fixture
          is shown on the Site under an incorrect competition name, then
        ...
        <li>
          For 'top goalscorer' markets only the goals scored in the
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        ...
        <li>
          ...
          matches or 'dead rubber' matches that have been shortened from
          five sets to three sets after the market has been loaded,
          provided that the match has been shortened in accordance with
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        ...
        <li>
          Horseracing Exchange Multiples are based on the Site's 'day of
          the race' markets (and not the Site's ante-post markets). The
          Site's horseracing ante-post rules do not therefore apply in
      ...
      <ul className="mt-1 mb-1 pl-6 list-disc text-justify leading-tight">
        <li>
          The Site's non-runner rule relates to the adjustment of odds
          on bets already matched when a horse in a race is declared a
          ...
          of which are described below) of that horse's chances of
        ...
        <li>
          ...
          <ul className="list-circle leading-normal pl-6">
            ...
            <li>
              ...
              amount equal to the non-runner's final reduction factor
              and all the unmatched offers to lay will be cancelled. If
              the non-runner's reduction factor is less than 2.5%,
              reductions will not be applied and unmatched bets will not
              be cancelled.
            </li>
            <li>
              ...
              non-runner's final reduction factor. Only if the
              non-runner's reduction factor is 4.0% or greater will all
        ...
        <li>
          ...
          the order in which they are brought to the Site's attention.
          If the Site becomes aware of more than one non-runner at the
          same time, it will remove the non-runners from the relevant
